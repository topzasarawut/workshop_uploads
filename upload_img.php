...
<html lang="en">
    <head>
        ...
        <title>Basic Upload PHP PDO by 2022</title>
        <!-- sweet alert  -->
                    ...
                    <table class="table table-striped  table-hover table-responsive table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="upload/<?php echo $k['img_file'];?>" target="_blank" class="btn btn-info
                                btn-sm"> เปิดดู </a></td>
                            <?php } ?>
                        </tbody>
                    </table>
                    <br>
                    <center>Basic Upload PHP PDO 2022</center>
                </div>
            </div>
        </div>
    </body>
                ...
                echo '<script>
                     setTimeout(function() {
                      swal({
                          ...
                          window.location = "upload_img.php"; //หน้าที่ต้องการให้กระโดดไป
                      });
                    }, 1000);
                </script>';
            }else{
